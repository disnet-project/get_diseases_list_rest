...
import edu.upm.midas.data.extraction.model.xml.XmlHighlight;
import edu.upm.midas.data.extraction.model.xml.XmlLink;
import edu.upm.midas.data.extraction.model.xml.XmlSection;
import edu.upm.midas.data.extraction.model.xml.XmlSource;
import edu.upm.midas.data.extraction.model.xml.title.*;
